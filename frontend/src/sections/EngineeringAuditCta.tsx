  ...
  return (
    <section className="relative overflow-hidden bg-transparent py-40 lg:py-56">
      <video
        ...
        src={`${import.meta.env.BASE_URL}videos/abouthero.mp4`}
        autoPlay
        muted
        loop
        playsInline
      ...
      <Container className="relative text-center">
        ...
        >
          ...
          >
            Start Your <br />
            <span className="text-brand-orange">Systems Audit.</span>
          </motion.h2>
          <motion.p
            variants={staggerItem}
            className="mb-16 max-w-2xl text-lg font-medium leading-relaxed text-white/90"
          >
            Discover exactly how custom AI software development and scalable architecture can eliminate manual workflows and optimize your conversion rates.
          </motion.p>
          <motion.div
            variants={staggerItem}
          ...
          >
            ...
            <Button size="lg" variant="secondary" className="h-16 px-12" href="/contact">
