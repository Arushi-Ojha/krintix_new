  ...
  return (
    <div className="w-[240px] bg-white border-r border-gray-100 flex flex-col h-screen sticky top-0 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
      ...
      <div className="p-8 pb-8 flex items-center gap-3">
        <img src={`${import.meta.env.BASE_URL}images/krintix-text.png`} alt="Krintix" className="h-6 w-auto" />
      </div>
          ...
          {menuItems.map((tab) => {
            ...
            return (
              ...
              >
                ...
                {isActive && (
                  <div className="absolute left-0 top-0 bottom-0 w-1 bg-pink-500 rounded-r-md" />
                )}
