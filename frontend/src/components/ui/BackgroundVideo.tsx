...
const VIDEO_ASSETS = {
  HOME: import.meta.env.BASE_URL + "videos/abouthero.mp4",
  TECHNICAL: import.meta.env.BASE_URL + "videos/abouthero.mp4",
  GENERAL: import.meta.env.BASE_URL + "videos/abouthero.mp4",
  ADMIN: import.meta.env.BASE_URL + "videos/abouthero.mp4",
};
